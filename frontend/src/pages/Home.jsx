    ...
    <div className="w-full overflow-hidden">
      <div className="w-full lg:h-[140vh] h-[70vh] relative">
        ...
        <div className="absolute lg:top-[30%] top-[75%]  md:top-[80%] w-full flex items-center justify-center gap-3 flex-wrap">
          ...
          >
            View All Courses{" "}
            <SiViaplay className="w-7.5 h-7.5 lg:fill-white fill-black" />
          </button>
          <button
          ...
          >
            ...
            <img
              src={ai}
              className="w-7.5 h-7.5 rounded-full hidden lg:block"
              alt=""
            />{" "}
            <img
              src={ai1}
              className="w-8.75 h-8.75 rounded-full lg:hidden"
              alt=""
            />
          </button>
        </div>
